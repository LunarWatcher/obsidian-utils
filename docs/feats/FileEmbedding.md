...
Obsidian has built-in file embedding, based on how you'd render an image:
```markdown
![[Filename]]
```
...
This is primarily meant for editor use. It also works in reader mode, but as it embeds a full editor, it will not export well.
